...
const { sendMessage, updateMessage, deleteMessage } = require('../controllers/mesages/mesController');
const { createConversation, getConversations, getConversationById, deleteConversation, 
    addParticipantsToGroup, removeParticipantFromGroup } = require('../controllers/conversation/conversationController');
...
router.post('/conversations/:conversationId/participants', addParticipantsToGroup); // Thêm thành viên vào nhóm
router.delete('/conversations/:conversationId/participants', removeParticipantFromGroup); // Xóa thành viên khỏi nhóm
