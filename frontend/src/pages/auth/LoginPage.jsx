            ...
            <Flex vertical style={stylesInline.form}>
                ...
                {isAdminApproval && (
                    <div style={{ marginTop: "1rem", color: "#D51D1D" }}>
                        <p>Please check your email ({adminEmail}) for admin approval link.</p>
                    </div>
                )}

                <AssistanceLink text=" Don't have an account?" link="Sign up" path="/auth/register" style={stylesInline.link} />
            </Flex>
...
const stylesInline = {
    form: { width: "60.3rem" },
    textCheckBox: { color: "#000", fontFamily: "Poppins", fontSize: "1.6rem", fontWeight: 400, lineHeight: "normal", marginLeft: ".7rem" },
    linkText: { color: "#D51D1D", fontFamily: "Poppins", fontSize: "1.6rem", fontWeight: 400, lineHeight: "normal" },
